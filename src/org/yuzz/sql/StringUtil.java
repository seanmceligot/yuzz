...
public class StringUtil {
	...
	public static final boolean compare( Object obj1, Object obj2 ) {
		...
		//_classLog.debug(obj1+"=="+obj2+" is "+isEqual);
		return isEqual;	
	}
	public static final boolean compare( String str1, String str2) {
		...
		//_classLog.debug(str1+"=="+str2+" is "+isEqual);
		return isEqual;	
	}
	/**
  ...
  //checks whether given string exists in a string array
	...
	//convert given string array to continuous string
