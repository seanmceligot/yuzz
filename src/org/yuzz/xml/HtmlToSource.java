...
public class HtmlToSource {
	public void parse(PrintWriter out, InputSource in) throws SAXException,
			IOException {
	...
	public static void main(String[] argv) throws Exception {
		...
		//PrintWriter out = new PrintWriter(new FileWriter(	"src/Out.java"));
		PrintWriter out = new PrintWriter(System.out);
		/*out.println("import static mil.mtmc.fso.xmlgen.NodeStatics.a;");
		out.println("import static mil.mtmc.fso.xmlgen.NodeStatics.n;");
		out.println("import static mil.mtmc.fso.xmlgen.NodeStatics.t;");
		out.println("import java.io.IOException;");
		out.println("public class Out {");
		out.println("public Node getDocument() throws IOException {");
		out.println("Node document = ");*/
		
		hp.parse(out, new InputSource(System.in));
		out.println(";");
		/*out.println("return document;}");
		out.println("public static void main(String[] a)  throws Exception { new Out().getDocument().write(System.out);} }");
		*/
		out.flush();
		out.close();
	}
